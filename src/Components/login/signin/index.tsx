                    ...
                    <FormProvider {...form}>
                        <form className='bg-[#fff] border-[#dddfe2] rounded-lg p-6 drop-shadow-xl' onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className='flex mt-[15px]'>
                                <a type='button' className='mx-auto w-2/3 text-white text-center bg-green-600 hover:opacity-90 hover:text-white rounded-md p-3 font-semibold' >Create New Account</a>
                            </div>
                        </form>
                    </FormProvider>
